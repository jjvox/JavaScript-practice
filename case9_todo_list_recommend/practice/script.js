;(function () {
  ...
  const changeEditMode = (e) => {
    ...
    if (e.target.className === 'todo_edit_button' || e.target.tagName == "LABEL") {
    ...
    if (e.target.className === 'todo_edit_cancel_button' || e.key === 'Escape'  ) {
  ...
  const editTodo = (e) => {
    if (e.target.className !== 'todo_edit_confirm_button' && e.key !== 'Enter') return;
